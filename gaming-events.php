...
$query = "SELECT id, title, event_date, location, coordinator, price, event_time, category_id FROM events WHERE category = 'Gaming'";
...
<head>
    ...
    <title>Gaming Events - College Event Management</title>
    <style>
        body {
        ...
        <div class="event-category">
            ...
            <div class="event-list">
                <?php if (!empty($events)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>No upcoming Gaming events available.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
