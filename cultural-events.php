...
// Fetch cultural events from the database
$query = "SELECT id, title, event_date, location, coordinator, price, event_time, category_id FROM events WHERE category = 'Cultural'";
...
<head>
    ...
    <title>Cultural Events - College Event Management</title>
    <style>
        body {
                ...
                <?php if (!empty($events)): ?>
                    <?php foreach ($events as $event): ?>
                        <div class="event-item">
                            ...
                            <a href="registration.php?event_id=<?php echo $event['id']; ?>&amp;category_id=<?php echo $event['category_id']; ?>" class="register-button">Register</a>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
                    <p>No upcoming Cultural events available.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
