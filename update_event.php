...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $seat_status = $_POST['seat_status'] ?? 'available';  // Seat availability
    ...
    <div class="form-container">
        ...
        <form method="POST">
            ...
            <select name="category" required>
                ...
                <option value="Gaming" <?php echo ($event['category'] == 'Gaming') ? 'selected' : ''; ?>>Gaming</option>
                <option value="Literary" <?php echo ($event['category'] == 'Literary') ? 'selected' : ''; ?>>Literary</option>
            </select>

            <input type="hidden" name="category_id" value="<?php echo htmlspecialchars($event['category_id']); ?>">
            ...
            <select name="seat_status" required>
                <option value="available" <?php echo ($event['seat_status'] == 'available') ? 'selected' : ''; ?>>Available</option>
                <option value="unavailable" <?php echo ($event['seat_status'] == 'unavailable') ? 'selected' : ''; ?>>Unavailable</option>
            </select>
